...
const FavBook = () => {
  return (
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between gap-12">
      ...
      <div className="me:w-1/2 space-y-6">
        ...
        <p className="mb-10 text-lg md:w-5/6">
          ...
          aliquid odio voluptas iure vitae molestiae aut inventore maiores
          deserunt natus quidem quae, quod, sunt cumque! Est non dicta nemo?
        </p>
